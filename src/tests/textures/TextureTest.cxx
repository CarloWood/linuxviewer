...
int main(int argc, char* argv[])
{
  ...
  catch (AIAlert::Error const& error)
  {
    ...
    Dout(dc::warning, "\e[31m" << error << ", caught in TextureTest.cxx\e[0m");
  }
#ifndef CWDEBUG // Commented out so we can see in gdb where an exception is thrown from.
  catch (std::exception& exception)
  {
    DoutFatal(dc::core, "\e[31mstd::exception: " << exception.what() << " caught in TextureTest.cxx\e[0m");
  }
#endif
