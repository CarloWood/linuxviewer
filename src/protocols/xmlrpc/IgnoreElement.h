...
{
  ElementDecoder* get_struct() override { return this; }
  ElementDecoder* get_array() override { return this; }
  ElementDecoder* get_member(std::string_view const&) override { return this; }
