...
class ShaderResourcePlusCharacteristic
{
 ...
 public:
  ShaderResourcePlusCharacteristic(shader_builder::ShaderResourceBase const* shader_resource, pipeline::CharacteristicRange const* characteristic_range, int fill_index) : m_shader_resource(shader_resource), m_characteristic_range(characteristic_range), m_fill_index(fill_index) { }
