...
struct AddShaderStageBridge
{
  ...
  virtual void retrieve_push_constant_ranges(shader_builder::ShaderInfoCache const& shader_info_cache) { }
  ...
  virtual void retrieve_vertex_input_descriptions(shader_builder::ShaderInfoCache const& shader_info_cache) { }
  ...
  void retrieve_from_cache(shader_builder::ShaderInfoCache const& shader_info_cache)
  {
    retrieve_push_constant_ranges(shader_info_cache);
    retrieve_vertex_input_descriptions(shader_info_cache);
  }
};
