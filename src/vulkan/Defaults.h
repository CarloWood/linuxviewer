...
DECLARE_PRINT_MEMBERS_CLASS(PhysicalDeviceMemoryProperties)
DECLARE_PRINT_MEMBERS_CLASS(MemoryType)
DECLARE_PRINT_MEMBERS_CLASS(MemoryHeap)
DECLARE_PRINT_MEMBERS_CLASS(MemoryRequirements)
DECLARE_PRINT_MEMBERS_CLASS(BufferCreateInfo)
DECLARE_PRINT_MEMBERS_CLASS(ImageCreateInfo)
