...
void Application::create_main_window(gui::WindowCreateInfo&& main_window_create_info)
{
...
#ifdef CWDEBUG
void Application::create_debug_messenger(DebugUtilsMessengerCreateInfoEXT&& debug_create_info)
{
...
void Application::create_vulkan_device(vulkan::DeviceCreateInfo&& device_create_info)
{
...
void Application::create_command_buffers(vulkan::CommandPoolCreateInfo&& command_pool_create_info)
{
