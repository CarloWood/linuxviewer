...
void Application::createInstance(vulkan::InstanceCreateInfo const& instance_create_info)
{
...
#endif
  m_uvh_instance = vk::createInstanceUnique(instance_create_info.base());
#ifdef CWDEBUG
  ...
  m_extension_loader.setup(*m_uvh_instance);
}
...
Application& Application::create_debug_messenger(DebugUtilsMessengerCreateInfoEXT&& debug_create_info)
{
  ...
  m_debug_messenger.setup(*m_uvh_instance, debug_create_info);
  return *this;
}
#endif
...
Application& Application::create_vulkan_device(vulkan::DeviceCreateInfo&& device_create_info)
{
  ...
  m_vulkan_device.setup(*m_uvh_instance, m_extension_loader, main_window_ptr()->vh_surface(), std::move(device_create_info));
